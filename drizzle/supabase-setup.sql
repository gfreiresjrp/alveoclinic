-- ============================================================
-- Alveo Clinic — banco completo para o Supabase
--
-- Cria as 22 tabelas e já popula com os dados de demonstração
-- (1 clínica, 4 usuários, 12 pacientes, 24 agendamentos,
-- estoque, protéticos, financeiro e conversas da Íris).
--
-- Como usar: Supabase -> SQL Editor -> New query -> cole tudo
-- isto -> Run. Roda de uma vez; não precisa quebrar em partes.
--
-- Login do sistema depois: admin@sorrisovivo.com.br / alveo123
-- ============================================================
